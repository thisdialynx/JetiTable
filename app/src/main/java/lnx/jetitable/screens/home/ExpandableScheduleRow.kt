...
@Composable
fun ExpandableScheduleRow(lesson: Lesson, index: Int, currentTime: Long, clipboardManager: ClipboardManager, localUriHandler: UriHandler, homeViewModel: HomeViewModel) {
                    ...
                    Card(
                        ...
                        modifier = Modifier
                            ...
                            .combinedClickable(
                                ...
                                onLongClick = { clipboardManager.setText(AnnotatedString(lesson.loadZoom)) }
                            )
                    ) {
                        Icon(
                    ...
                    Card(
                        ...
                        modifier = Modifier
                            ...
                            .combinedClickable(
                                ...
                                onLongClick = { clipboardManager.setText(AnnotatedString(lesson.loadMoodleStudent)) }
                            )
                    ) {
                        Icon(
