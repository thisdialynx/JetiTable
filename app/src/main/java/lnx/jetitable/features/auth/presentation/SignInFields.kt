...
import lnx.jetitable.ui.icons.google.Visibility
import lnx.jetitable.ui.icons.google.VisibilityOff
...
fun SignInFields(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        OutlinedTextField(
            ...
            singleLine = true,
            leadingIcon = { Icon(imageVector = Mail, contentDescription = "Mail icon") },
            modifier = Modifier
                .fillMaxWidth()
        ...
        OutlinedTextField(
            ...
            trailingIcon = {
                val visibilityIcon: Pair<ImageVector, Int> =
                    if (passwordVisible) Visibility to R.string.show_password
                    else VisibilityOff to R.string.hide_password
